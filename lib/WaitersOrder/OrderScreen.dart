// ignore_for_file: prefer_interpolation_to_compose_strings, sort_child_properties_last, prefer_const_constructors
...
class _MyHomePageState extends State<OrdersPage> {
  ...
  // final OrderModel product = Get.find();

  // final products = Get.put(OrderModel());
